...
var adbot = {
    ...
    process_ads: function() {
        ...
        adbot.ad_elements.each( function() {
            ...
            if ( ad.screenshot_width == 1 && ad.screenshot_height == 1 ) {
                return; // 1x1 elements are for tracking purposes and are not ads. strip them out even though they are present in adbot.ad_elements
            }
