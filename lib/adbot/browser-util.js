...
var adbot = {
    ...
    process_ads: function() {
        ...
        adbot.ad_elements.each( function() {
            ...
            ad.element_for_screenshot = ad_element;
            while ( true ) {
                var screenshot = adbot.ad_screenshot( ad.element_for_screenshot );
                ...
                if ( ! ADBOTjQuery(ad.element_for_screenshot).parent().is("div") ) {
                    ADBOTjQuery(ad.element_for_screenshot).wrap('<div />');
                }
                ad.element_for_screenshot = ADBOTjQuery(ad.element_for_screenshot).parent()[0]
            }
    ...
    highlight_ads: function() {
        ADBOTjQuery.each(adbot.ads, function( i, ad ) { ADBOTjQuery(ad.element_for_screenshot).css("border", "3px solid red"); } );
    },
